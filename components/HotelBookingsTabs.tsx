...
import { BookingsGridSkeleton } from "./BookingSkeleton";

function BookingsGrid({ bookings, onBookingSelect }: { bookings: Booking[], onBookingSelect: (booking: Booking) => void }) {
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      {bookings.map((booking) => (
        <Card key={booking.id} onClick={() => onBookingSelect(booking)} className="cursor-pointer hover:shadow-lg transition-all duration-300">
...
function BookingsContent({ status, bookings, isLoading, error, onBookingSelect }: { 
  ...
  return <BookingsGrid bookings={bookings} onBookingSelect={onBookingSelect} />;
}
